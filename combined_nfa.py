...
def create_combined_nfa():
    ...
    states = {"start"}.union(dec_nfa.states).union(oct_nfa.states).union(hex_nfa.states)

    # Combined alphabet
    alphabet = dec_nfa.alphabet.union(oct_nfa.alphabet).union(hex_nfa.alphabet)
    ...
    accepting_states = dec_nfa.accepting_states.union(oct_nfa.accepting_states).union(
        hex_nfa.accepting_states
    )
